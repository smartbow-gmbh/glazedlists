...
public class ListBlocksLinearTest {
    ...
    public void testCombiningChanges() {
        ...
        // insert of the same delete block will result in a update block
        listBlocks.delete(8, 10);
        listBlocks.insert(8, 10);
        // this will get merged into the previous update block
        ...
        // a single big update block
        assertNext(8, ListEvent.UPDATE, iterator);
        assertNext(9, ListEvent.UPDATE, iterator);
    ...
    public void testOutOfOrder() {
        ...
        // update of a insert block is allowed
        listBlocks = new BlockSequence();
        ...
        // delete of a insert block is allowed
        listBlocks = new BlockSequence();
        assertTrue(listBlocks.delete(2, 8));
        assertTrue(listBlocks.insert(4, 6));
    ...
    public void testIterateByBlocks() {
        ...
        assertNextBlock(8, 12, ListEvent.UPDATE, iterator);
